...
import os
train_df = pd.read_excel('/Users/oliver/YOGA/Yoga/Data/train.xlsx') # Load the `train` file
test_df = pd.read_excel('/Users/oliver/YOGA/Yoga/Data/test.xlsx') # Load the `test` file
train_df_tr = pd.read_csv('/Users/oliver/YOGA/Yoga/Personal/Oliver/train_df_tr2.csv', delimiter=';') # Load the traductions file
test_df_tr = pd.read_csv('/Users/oliver/YOGA/Yoga/Personal/Oliver/test_df_tr2.csv', delimiter=';') # Load the traductions file
...
def save_submission(prediction):
    ...
    output.to_csv(f'/Users/oliver/YOGA/Yoga/Personal/Oliver/sample_submission{t}.csv')
